...
def termgraph_prepare():
    ...
    parser.add_argument("--y-space",default=30,help="Character count for graph height")
    parser.add_argument("--x-space",default=118,help="Character count for graph width")
